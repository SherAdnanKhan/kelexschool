...
<div class="kt-portlet kt-portlet--mobile">
  <div class="kt-portlet__body kt-portlet__body--fit">
    ...
    <!-- begin: Datatable -->
    <div class="kt-datatable" id="kt_apps_feedbacks_list_datatable"></div>
    <!--end: Datatable -->
...
<script src="{{ asset('pages/js/feedback-datatable.js') }}" type="text/javascript"></script>
@endsection('pageJs')